        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`appearance-none relative block w-full px-3 py-3 border rounded-lg placeholder-gray-500 text-white bg-gray-800 border-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link href="/forgot-password" className="font-medium text-red-400 hover:text-red-300 transition-colors">
          ...
          <div className="text-center">
            <p className="text-gray-400">
              ...
              <Link href="/signup" className="font-medium text-red-400 hover:text-red-300 transition-colors">
                Sign up here
              </Link>
            </p>
          </div>
