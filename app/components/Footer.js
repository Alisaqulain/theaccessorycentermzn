      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div >
                <img src="./car.png" alt="Car Accessories Logo" className="w-38 h-20" />
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-400">
              ...
              <p>Phone: 7456886910, 9045030110</p>
              <p>Email: shazizaidi52058@gmail.com</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2025 Developed by <a href="https://devspheresolutions.in/" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:text-red-300 transition-colors">DevSpher</a>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
